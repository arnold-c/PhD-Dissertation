...
Despite the mean daily noise incidence being set to equivalent values for the dynamical and Poisson-only simulations, drastically different results are observed.
